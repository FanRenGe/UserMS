...
<body>
    ...
    <div class="TopBack">
    <div  class="TopTitle">员工信息管理系统</div>
        <div class="TopMes">
            登录用户：<font color="red"><%=userName%></font>&nbsp;&nbsp;&nbsp;当前日期：<font color="red"><%=DateTime.Now.ToLongDateString()%></font>&nbsp;<a href="UpdatePwd.aspx" target="main"
